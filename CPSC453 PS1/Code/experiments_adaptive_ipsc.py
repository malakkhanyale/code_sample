...
#VISUALIZING iPSC DATA WITH DIFFUSION MAP ADAPTIVE GAUSSIAN k = 2, t = 1
...
plt.title('iPSC Markov Matrix Eigenvalues-  k = 2, t = 1')
plt.plot(xdata, np.flip(diff_eig))
# plt.show()
plt.savefig('iPSC Markov Matrix Eigenvalues-  k = 2, t = 1.png')
...
fig = plt.figure()
plt.title("iPSC DC2 and DC3- k = 2, t = 1")
plt.xlabel("DC2")
plt.ylabel("DC3")
plt.scatter(plane[:, 0], plane[:,1])
# plt.show()
plt.savefig('iPSC DC2 and DC3- k = 2, t = 1.png')
...
fig = plt.figure()
plt.title("iPSC DC3 and DC4- k = 2, t = 1")
plt.xlabel("DC3")
plt.ylabel("DC4")
plt.scatter(plane[:, 0], plane[:,1])
# plt.show()
plt.savefig('iPSC DC3 and DC4- k = 2, t = 1.png')
...
fig = plt.figure()
plt.title("iPSC DC2 and DC4- k = 2, t = 1")
plt.xlabel("DC2")
plt.ylabel("DC4")
plt.scatter(plane[:, 0], plane[:,1])
# plt.show()
plt.savefig('iPSC DC2 and DC4- k = 2, t = 1.png')